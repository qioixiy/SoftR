...
RBFrameAlloctor* ATEST::all = RBMemoryManager::Instance()->get_frameallocator();
void* ATEST::nodes = NULL;
RBPoolAllctor* ATEST::pool = nullptr;
...
void c__main()
{
	...
	pool_alloctor.print_list<ATEST>(res);
